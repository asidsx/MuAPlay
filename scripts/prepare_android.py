...
public class AudioForegroundService extends Service {
    ...
    public static final String ACTION_PLAY = "com.muaplay.app.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.muaplay.app.ACTION_PAUSE";
    public static final String ACTION_TOGGLE = "com.muaplay.app.ACTION_TOGGLE";
    public static final String ACTION_NEXT = "com.muaplay.app.ACTION_NEXT";
    public static final String ACTION_PREV = "com.muaplay.app.ACTION_PREV";
    public static final String ACTION_UPDATE = "com.muaplay.app.ACTION_UPDATE";
